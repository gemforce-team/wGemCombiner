...
namespace WGemCombiner
{
    public partial class HelpForm : Form
    {
        ...
        {
            addHelpMessage("Working with the combiner", "Paste gem combining equations or a parenthesis formula into the textbox, then click 'Get Instructions'.\n" +
            ...
            addHelpMessage("Speccing", "Gem Combiner now supports speccing.\n" +
            ...
            addHelpMessage("Input Format", "Example of combining equations:\n" +
                "(val = 1)\t0 = g1 orange\n(val = 2)\t1 = 0 + 0\n(val = 3)\t2 = 1 + 0\n" +
            ...
            addHelpMessage("Presets", "Preset schemes are supported. To use one, first select a color + combine/spec from the top drop-down list.\n" +
...
#if DEBUG
            addHelpMessage("Importing new presets", "In debug mode you can import new presets from a .txt file with recipes.\n"+
            ...
            addHelpMessage("Credits", "Gem Combiner was made by Suuper.\n" +
                "\n" +
                "Contributors:\n" +
